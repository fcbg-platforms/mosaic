...
void fade_out_widget(QWidget* w, int durationMs = 150,
...
QPropertyAnimation* animate_collapse(QWidget* body, bool expand,
                                      int durationMs = 180,
                                      std::function<void()> onFinished = {});
...
// fade-in finishes).
void crossfade_stacked_widget(QStackedWidget* stack, int newIndex,
                               int durationMs = 130,
