...
.. _file_src_trigger_parallel_port_trigger.hpp:
...
Definition (``src/trigger/parallel_port_trigger.hpp``)
------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_src_trigger_parallel_port_trigger.hpp.rst
...
- :ref:`exhale_class_classmosaic_1_1_parallel_port_trigger`
