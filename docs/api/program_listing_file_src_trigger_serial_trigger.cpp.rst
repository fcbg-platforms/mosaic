...
.. _program_listing_file_src_trigger_serial_trigger.cpp:

Program Listing for File serial_trigger.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_trigger_serial_trigger.cpp>` (``src\trigger\serial_trigger.cpp``)
