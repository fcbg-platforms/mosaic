...
.. _program_listing_file_src_video_video_manager.cpp:

Program Listing for File video_manager.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_video_video_manager.cpp>` (``src\video\video_manager.cpp``)
