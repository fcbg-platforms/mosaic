...
.. _program_listing_file_src_trigger_lsl_inlet.cpp:

Program Listing for File lsl_inlet.cpp
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_trigger_lsl_inlet.cpp>` (``src/trigger/lsl_inlet.cpp``)
