...
.. _program_listing_file_src_analysis_skeleton3d_result.hpp:

Program Listing for File skeleton3d_result.hpp
==============================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_analysis_skeleton3d_result.hpp>` (``src\analysis\skeleton3d_result.hpp``)
...
.. code-block:: cpp
   ...
   /// One triangulated keypoint within one reconstructed person. `valid`
